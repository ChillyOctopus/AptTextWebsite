...
function addMaintenance() {
  ...
  const issue = "ddddddddddd What do you mean ohhoho oh  when you want to say yes but you have to say no what do you mean  ohohoh  when you want to say yes, but you have to say no what do you mean.";
